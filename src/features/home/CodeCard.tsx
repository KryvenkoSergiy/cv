import { personalInfo, stats, coreStack } from "../../shared/data/cv";
  ...
  <div className='glassmorphism rounded-2xl p-6 card-hover'>
    ...
    <div className='font-mono text-sm leading-7 space-y-0.5'>
      ...
      <p className='pl-5'>
        ...
        <span className='text-white/40'>:</span>{" "}
        <span className='text-orange-300'>{personalInfo.yearsOfExperience}</span>
        <span className='text-white/40'>,</span>
      </p>
      <p className='pl-5'>
      ...
      <p className='pl-10'>
        <span className='text-green-300'>'{coreStack[0]}'</span>
        <span className='text-white/40'>,</span>{" "}
        <span className='text-green-300'>'{coreStack[1]}'</span>
        <span className='text-white/40'>,</span>
      </p>
      <p className='pl-10'>
        <span className='text-green-300'>'{coreStack[2]}'</span>
        <span className='text-white/40'>,</span>{" "}
        <span className='text-green-300'>'{coreStack[3]}'</span>
        <span className='text-white/40'>,</span>
      </p>
      <p className='pl-5'>
        <span className='text-white/40'>],</span>
